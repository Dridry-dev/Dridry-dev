...
## 👨🏼‍💻 Project:
  ...
  Quest-buddy is my final project for the Wagon training program.<br>It is a virtual assistant designed to help individuals improve their skills in a self-guided manner.<br> Similar to the "quest book" found in video games, it offers users the opportunity to complete various quests in order to progress in the game and in real life.<br> Currently, the only fully functional quest is in the "Sports" category and is called "Push-up." <br>The website is designed for mobile devices, with a responsive design for larger screens planned but not fully implemented yet. Thank you in advance for your understanding.<br>
